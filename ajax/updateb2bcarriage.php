<?php
    ...
    if(isset($_POST['carriage_val']) )
    {
        
        $carriage_val = trim($_POST['carriage_val']);
        
        if($carriage_val == "") 
        $carriage_val = 0;
        
        $_SESSION['carriage_amount'] = $carriage_val;
        ...
        echo json_encode(array("status" => 0,"msg" => "Carriage value looks empty." , "response" => "fail" ));
        exit;
    }
